...
for dataset in $dataset_keys; do
  ...
  IFS='_' read -r prefix datatype year id institute version date <<< "$out"

  # Construct the base name for PhysicalChemical format: SHARK_DataType_Year_ID_INSTITUTE
  base_name="${prefix}_${datatype}_${year}_${id}_${institute}"
